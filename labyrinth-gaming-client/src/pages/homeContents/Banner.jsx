	...
	return (
		<div className="relative">
			<div className="">
				...
				<div className="pt-10 pl-10 absolute top-0 left-0 h-full text-black rounded-xl bg-gradient-to-r from-[#6F6F6F] to=[#F6F6F6]">
					...
					<div data-aos="slide-right" data-aos-duration="800" data-aos-delay="200" className="text-start">
						<Link to='/alltoys'>
